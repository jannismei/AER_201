...
int find_line(){
  ...
  if (find_line_state == 0){ //determine timestamp for when the function enters
    ...
    analogWrite(pin_speed_L, highSpeed_L); // previously 255, 50
    analogWrite(pin_speed_R, 58);
    ...
    analogWrite(pin_speed_L, mediumSpeed_L);
    analogWrite(pin_speed_R, mediumSpeed_R);
    ...
    analogWrite(pin_speed_L, mediumSpeed_L); // previously 103, 100
    analogWrite(pin_speed_R, mediumSpeed_R);
