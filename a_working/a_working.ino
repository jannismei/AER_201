...
unsigned int travelSpeed_L = 157, travelSpeed_R = 150, startSpeed_L = 90, startSpeed_R = 85, max_speed = 255, min_speed = 20, rotate = 10; // need to make sure increments are right (PWM between 0 and 255) // 105 and 65
