...
// correct_for_red_line(), correct_for_red_line_2_turns_case1(), correct_for_red_line_2_turns_case2_4(), correct_for_red_line_2_turns_case3()

void correct_for_red_line()
{
   if ( (col_S < 4) && (col_T > 4) )
   {
     num_cols_to_pass = num_cols_to_pass - 1; 
   }
   else if ( (col_S > 4) && (col_T < 4) )
   {
     num_cols_to_pass = num_cols_to_pass - 1; 
   }
   return;
...
void correct_for_red_line_2_turns_case1()
{ // turn right twice, case 1
   if (col_S < 4)
   {
      num_cols_to_pass = num_cols_to_pass - 1; 
   }
...
void correct_for_red_line_2_turns_case2_4()
{ // turn right twice, case 2 and case 4
      num_cols_to_pass = num_cols_to_pass - 1;
      return;
}

void correct_for_red_line_2_turns_case3()
{ // turn right twice, case 3
   if (col_S > 4)
   {
      num_cols_to_pass = num_cols_to_pass - 1; 
   }
...
int sensing_passing_line()
{
 ...
 if ( ( (time - pass_line_time) < 1000) && (0 == sensing_passing_line_flag) )
 {
