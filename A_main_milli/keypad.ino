...
do
{
  ...
  if(key)  // Check for a valid key.
  {
      ...
      if ('A' == key)
      {
        Serial.println(key);
        input_hopper_1 = 3;
        Serial.println("Input_hopper_1 row coordinate, then column coordinate, followed by its orientation");
       // Serial.println(input_hopper_1);
      }
      else if ('B' == key)
      {
        Serial.println(key);
        input_hopper_2 = 3;
        Serial.println("Input_hopper_2 row coordinate, then column coordinate, followed by its orientation");
        //Serial.println(input_hopper_2);
      }
      else
        {
