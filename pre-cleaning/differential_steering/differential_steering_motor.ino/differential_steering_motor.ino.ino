...
const int controlPin1 = 6; // connected to pin 7 on the H-bridge
const int controlPin2 = 7; // connected to pin 2 on the H-bridge
//const int controlPin3 = 4; // not sure what this connects to.
//const int controlPin4 = 5; // same
