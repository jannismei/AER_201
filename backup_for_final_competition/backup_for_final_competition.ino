...
unsigned int travelSpeed_L = 187, travelSpeed_R = 170, startSpeed_L = 127, startSpeed_R = 120, max_speed = 255, min_speed = 20, rotate = 10; // need to make sure increments are right (PWM between 0 and 255) // 105 and 65
unsigned int slowSpeed_L = 75, slowSpeed_R = 70; // Mar 24, changed to make corner_hopper work (was originally 103/103)
...
else if (4 == loop_section)
{
  ...
  {
      if (1 == went_to_left_corner) //April 6: This weird stuff was created a while ago and was used to handle some weird turning to get us to the left corner
